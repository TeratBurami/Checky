...
describe('System Test Suite 1: Teacher Class Management Workflow', function() {
    ...
    it('Test Case 1.1: Create a New Class', async function() {
        ...
        await driver.wait(until.urlIs('http://localhost:3001/class/create'), 60000);
        console.log('[Action] Navigated to Create Class page');
        
        createdClassName = `Introduction to English`;
        
        // Fill in class details
        const nameInput = await driver.wait(until.elementLocated(By.id('name')), 60000);
        ...
        const classCard = await driver.wait(until.elementLocated(By.xpath(`//h3[contains(text(), '${createdClassName}')]`)), 60000);
        ...
        // Extract class code
        const classCodeElement = await driver.wait(until.elementLocated(By.id('class-code')), 60000);
    ...
    it('Test Case 1.2: Create an Invite for a Student', async function() {
        ...
        const inviteInput = await driver.wait(until.elementLocated(By.css('input[placeholder*="email" i]')), 60000);
        ...
        const studentEmail = await driver.wait(until.elementLocated(By.xpath("//p[contains(text(), 'reze@gmail.com')]")), 60000);
    ...
    it('Test Case 1.3: Edit an Existing Class', async function() {
        ...
        const editButton = await driver.wait(until.elementLocated(By.css('button[title="Edit Class Details"]')), 60000);
        await editButton.click();
        console.log('[Action] Clicked Edit Class button');
        
        // Wait for edit page
        await driver.wait(until.urlContains('/edit'), 60000);
        ...
        const updatedClassElement = await driver.wait(until.elementLocated(By.xpath(`//*[contains(text(), '${updatedClassName}')]`)), 60000);
    ...
    it('Test Case 1.4: Delete an Existing Class', async function() {
        ...
        const confirmDeleteButton = await driver.wait(until.elementLocated(By.xpath("//button[contains(text(), 'Confirm Delete')]")), 60000);
