export const ClockSVG: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
...
// Component: CheckCircle (Used for Completed Tab icon)
export const CheckCircleSVG: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
...
// Component: BookOpen (Used for To-do Tab icon)
export const BookOpenSVG: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
...
// Component: Folder (Used for Class Group icon)
export const FolderSVG: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.93a2 2 0 0 1-1.66-.9l-.82-1.2A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13c0 1.1.9 2 2 2z"></path></svg>
);

// Component: ChevronDown (Used in Header for profile dropdown)
export const ChevronDownSVG: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
...
// Component: LayoutGrid (Used for empty state)
export const LayoutGridSVG: React.FC<{ className?: string }> = ({ className = "w-10 h-10" }) => (
...
// Component: Bell (Used in Header for notifications)
export const BellSVG: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
